 ...
 */
public abstract class LOLHttpCallback<T> extends AbsCallback<T> {

    private Class<T> clazz;
    //private Type type;

    public LOLHttpCallback(Class<T> clazz){
        this.clazz = clazz;
    }

   /* public LOLHttpCallback(Type type) {
        this.type = type;
    }*/
    ...
    public T parseNetworkResponse(Response response) throws Exception {
        ...
        final int code = jsonObject.optInt("code", 200);
        final String data = jsonObject.optString("data", "");
        final String message = jsonObject.optString("message", "");
        if (code == 200){
            if (clazz == String.class) return (T) message;
        ...
        OkHttpUtils.getInstance().getDelivery().post(new Runnable() {
            ...
            public void run() {
                ...
                ToastUtils.getInstance().showToast(code+message);
            }
        });
        return null;
    }
